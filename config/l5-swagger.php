...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'Laravel OpenAPI/Swagger UI',
            ],
    ...
    'defaults' => [
        ...
        'securityDefinitions' => [
            'securitySchemes' => [
                ...
                'ApiKeyAuth' => [
                    ...
                    'description' => 'Use X-API-KEY: '.env('API_TOKEN', 'YOUR_API_TOKEN').' in header of request to API access',
        ...
        */
        ...
        'constants' => [
            ...
            'L5_SWAGGER_CONST_HOST_HTTPS' => env('APP_URL', 'https://localhost'),
        ],
    ],
];
