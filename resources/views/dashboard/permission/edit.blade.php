...
@section('title', trans('dashboard.edit-permission'))
...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">{{ __('dashboard.edit-permission') }}</h1>
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ __('dashboard.edit-permission') }}</li>
        </ol>
    </div>
            ...
            <div class="row">
                <div class="col-12">
                    @component('dashboard.permission._form')
                        ...
                        @slot('action', route('permission.update', ['permission' => $permission, 'locale' => $locale]))
                    @endcomponent
                </div>
            </div>
        </div>
