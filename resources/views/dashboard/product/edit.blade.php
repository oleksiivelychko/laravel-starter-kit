...
@section('title', trans('dashboard.edit-product'))
...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">{{ __('dashboard.edit-product') }}</h1>
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ __('dashboard.edit-product') }}</li>
        </ol>
    </div>
            ...
            <div class="row">
                <div class="col-12">
                    @component('dashboard.product._form')
                        ...
                        @slot('action', route('product.update', ['product' => $product, 'locale' => $locale]))
                    @endcomponent
                </div>
            </div>
        </div>
